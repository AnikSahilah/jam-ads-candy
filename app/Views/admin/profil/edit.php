                ...
                <div class="app-card-body px-4 w-100">
                    <form action="<?= base_url('admin/profil/proses_edit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea style="height: 8em;" class="form-control" id="link_maps" name="link_maps" rows="3"><?= $profil_pengguna->link_maps ?? ''; ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <p>*Ukuran foto favicon disarankan 48x48 pixels</p>
                        </div>
                        <div class="mb-3">
                            ...
                            <p>*Ukuran logo disarankan 300x300 pixels</p>                        
                        </div>
                        <div class="mb-3">
                            ...
                            <p>*Ukuran foto utama disarankan 572x868 pixels</p>                          
                        </div>
                        <div class="mt-4">
