        ...
        <div class="row g-4 settings-section">
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="meta_title_in" name="meta_title_in" value="<?= $aktivitasData->meta_title; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Meta Description (In)</label>
                                        <textarea class="form-control" id="meta_description_in" name="meta_description_in"><?= $aktivitasData->meta_description; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Meta Title (En)</label>
                                        <input type="text" class="form-control" id="meta_title_en" name="meta_title_en" value="<?= $aktivitasData->meta_title_inggris; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Meta Description (En)</label>
                                        <textarea class="form-control" id="meta_description_en" name="meta_description_en"><?= $aktivitasData->meta_description_inggris; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                    ...
                    <?php else : ?>
                        <p><?= lang('Blog.noActivityDataFound'); ?></p>
                    <?php endif; ?>
                </div>
            </div><!--//app-card-->
        </div><!--//row-->
