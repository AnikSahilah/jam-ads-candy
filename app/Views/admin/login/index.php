...
<div class="row g-0 app-auth-wrapper">
	<div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		<div class="d-flex flex-column align-content-end">
			...
			<div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img class="logo-icon me-2" src="<?php echo base_url('assets/images/Blue White Badge Watch Logo.png'); ?>" alt="logo" style="width: 150px; height: auto;"></a></div>
			<h2 class="auth-heading text-center mb-5">Log in Timeless Elegance</h2>
